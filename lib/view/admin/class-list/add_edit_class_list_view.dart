...
class _AddEditClassListViewState extends State<AddEditClassListView> {
  ...
  void initState() {
    ...
    if (widget.arguments != null && widget.arguments is ClassListModel) {
      ...
      if (classListModelForUpdate != null) {
        ...
        studentList = classListModelForUpdate!.studentList != null && classListModelForUpdate!.studentList!.isNotEmpty ? classListModelForUpdate!.studentList! : [];
        selectedCourseBatchYear = listOfCourseBatchYear.any(
          (element) => element.admissionYear == classListModelForUpdate!.courseBatchYear?.admissionYear && element.passingYear == classListModelForUpdate!.courseBatchYear?.passingYear,
        )
  ...
  bool validateFields() => classDivisionController.text.isNotEmpty && selectedCourse != null && selectedCourse!.id != -1000 && selectedCourseBatchYear != null && studentList.isNotEmpty;
    ...
    if (selectedCourse != null) {
      ...
      for (int index = 0; index < 40; index++) {
        listOfCourseBatchYear.add(
          CourseBatchYear(id: index + 1, admissionYear: startDate + index, passingYear: (startDate + index) + duration),
        );
      }
    }
  }
        ...
        () => courseController.loader.value
            ...
            : ListView(
                ...
                children: [
                    ...
                    onTap: () async {
                      await showCommonBottomSheet(
                        ...
                        listOfItems: courseController.courseList
                            ...
                            .toList(),
                        selectValue: selectedCourse != null && selectedCourse!.id != -1000
                        ...
                        onSubmit: (selectValue) {
                          if (courseController.courseList.any(
                            ...
                            setState(() {
                              selectedCourse = courseController.courseList.singleWhere(
                                (element) => element.id == selectValue.id,
                              );
                              generateListForCourseBatchYear();
                            });
                  ...
                  if (selectedCourse != null && listOfCourseBatchYear.isNotEmpty)
                    Column(
                        ...
                        GestureDetector(
                            ...
                            await showCommonBottomSheet(
                              ...
                              listOfItems: listOfCourseBatchYear
                                  .map(
                                    (e) => BottomSheetSelectionModel(
                                      id: e.id ?? 0,
                                      name: '${e.admissionYear} - ${e.passingYear}',
                                    ),
                                  )
                                  .toList(),
                              selectValue: selectedCourseBatchYear != null
                                  ? BottomSheetSelectionModel(
                                      ...
                                      name: '${selectedCourseBatchYear!.admissionYear} - ${selectedCourseBatchYear!.passingYear}',
                                    )
                                  : null,
                              onSubmit: (selectValue) {
                                num admissionYear = num.tryParse(selectValue.name.split("-").first.trim()) ?? 0;
                                num passingYear = num.tryParse(selectValue.name.split("-").last.trim()) ?? 0;
                                if (listOfCourseBatchYear.any(
                                  (element) => element.admissionYear == admissionYear && element.passingYear == passingYear,
                                )) {
                                  setState(() {
                                    selectedCourseBatchYear = listOfCourseBatchYear.singleWhere(
                                      (element) => element.admissionYear == admissionYear && element.passingYear == passingYear,
                                    );
                                  });
                                }
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                AppTextTheme.textSize14(
                                  label: selectedCourseBatchYear != null ? '${selectedCourseBatchYear!.admissionYear} - ${selectedCourseBatchYear!.passingYear}' : 'Select Course Batch Year',
                                  color: AppColors.black.withAlpha(
                                    (255 * 0.7).toInt(),
                                  ),
                                ),
                                                      ...
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          if (student.gender.isNotEmpty) ...[
                                                            ...
                                                            SizedBox(width: Dimens.width20),
                                                            AppTextTheme.textSize14(
                                                              label: student.gender.toLowerCase() == 'male'
                                                                  ? 'Male'
                      ...
                      builder: (context, setInnerState) {
                        return GestureDetector(
                          ...
                          onTap: () async {
                            ...
                            if (filePicker != null) {
                              try {
                                String filePath = filePicker!.paths.first != null && filePicker!.paths.first!.isNotEmpty ? filePicker!.paths.first! : '';
                                ...
                                studentList = rowsAsListOfValues.map(
                                  (e) {
                                    ...
                                    num id = index + 1;
                                    String rollNumber = e[0].toString();
                                    String name = e[1].toString();
                                    String mobileNumber = e[2].toString();
                                    String email = e[3].toString();
                                    String gender = e[4].toString();
                                    String password = e[5].toString();
                                    return Student(
                                      id: id,
                            ...
                            child: rowsAsListOfValues.isNotEmpty
                                ? Stack(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsets.symmetric(
                                          vertical: Dimens.height140,
                                          horizontal: Dimens.width140,
                                        ),
                                        child: Column(
                                          mainAxisSize: MainAxisSize.min,
                                          crossAxisAlignment: CrossAxisAlignment.center,
                                ...
                                : AppTextTheme.textSize14(
                                    label: 'Upload CSV by clicking inside the Box',
                                    fontWeight: FontWeight.w600,
                                    color: AppColors.black.withAlpha(
                                      (255 * 0.5).toInt(),
                                    ),
                  ...
                  if (classListModelForUpdate == null && studentList.isEmpty) ...[
                    SizedBox(height: Dimens.height12),
                    AppTextTheme.textSize13(
                      label:
                          'Note :- Please upload a CSV file containing the data in the following format:roll no., name, mobile number, email, gender and password, with no titles - just the data itself.',
                      maxLines: 3,
                      color: AppColors.black,
                    ),
                  ],
                  ...
                  GestureDetector(
                    ...
                    onTap: () async {
                      ...
                      if (!isError) {
                        if (widget.arguments != null && classListModelForUpdate != null) {
                          ClassListModel classListModel = ClassListModel(
                            documentID: classListModelForUpdate!.documentID,
                            id: classListModelForUpdate!.id,
                            name: '${selectedCourse?.name} ${selectedCourseBatchYear?.admissionYear}-${selectedCourseBatchYear?.passingYear}' == classListModelForUpdate!.name
                                ? classListModelForUpdate!.name
                            ...
                            courseBatchYear: selectedCourseBatchYear ?? CourseBatchYear.empty(),
                          ...
                          ClassListModel classListModel = ClassListModel(
                            ...
                            id: addEditClassListController.globalClassList.isNotEmpty ? addEditClassListController.globalClassList.length + 1 : 1,
                            name: '${selectedCourse?.name} ${selectedCourseBatchYear?.admissionYear}-${selectedCourseBatchYear?.passingYear}',
                            division: classDivisionController.text,
                            course: selectedCourse ?? Course.empty(),
                            courseBatchYear: selectedCourseBatchYear ?? CourseBatchYear.empty(),
                            admin: addEditClassListController.admin ?? Admin.empty(),
                            studentList: studentList,
                          );
                      ...
                      child: Obx(
                        () => addEditClassListController.submitLoader.value
                            ...
                            : AppTextTheme.textSize16(
                                label: widget.arguments != null && classListModelForUpdate != null ? 'Update Class List' : 'Add Class List',
                                color: AppColors.white,
                              ),
                      ),
                    ),
